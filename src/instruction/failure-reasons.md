...
| :-----------------------: | :---------: |
| `UNMAPPED_REASON` | An unexpected error occurred. |
...
| Failure Reason Identifier | Description |
| :-----------------------: | :---------: |
| `INVALID_WRITE_NOTE_INSTRUCTION` | It was not possible to read the note from the given basic instruction. |
| `WRITE_NOTE_INSTRUCTION_WITH_NON_WRITABLE_NOTE` | The string of the given basic instruction does not exist on the given tablature. |
...
| Failure Reason Identifier | Description |
| :-----------------------: | :---------: |
| `METHOD_INSTRUCTION_WITHOUT_IDENTIFIER` | It was not possible to identify the method instruction under the given alias. |
<!-- | `METHOD_INSTRUCTION_WITH_UNMAPPED_IDENTIFIER` | No writing operation mapped for the method instruction identified. | -->
...
| Failure Reason Identifier | Description |
| :-----------------------: | :---------: |
| `WRITE_FOOTER_INSTRUCTION_WITHOUT_ARGUMENTS` | The method instruction `footer` was called with no arguments. |
| `WRITE_FOOTER_INSTRUCTION_WITH_UNMAPPED_ARGUMENTS` | The method instruction `footer` was called with more than one argument. |
<!-- | `WRITE_FOOTER_INSTRUCTION_WITH_INVALID_FOOTER` | The method instruction `footer` was called with an invalid footer message. | -->
...
| Failure Reason Identifier | Description |
| :-----------------------: | :---------: |
| `WRITE_HEADER_INSTRUCTION_WITHOUT_ARGUMENTS` | The method instruction `header` was called with no arguments. |
| `WRITE_HEADER_INSTRUCTION_WITH_UNMAPPED_ARGUMENTS` | The method instruction `header` was called with more than one argument. |
<!-- | `WRITE_HEADER_INSTRUCTION_WITH_INVALID_HEADER` | The method instruction `header` was called with an invalid header message. | -->
...
| Failure Reason Identifier | Description |
| :-----------------------: | :---------: |
| `SET_SPACING_INSTRUCTION_WITHOUT_ARGUMENTS` | The method instruction `spacing` was called with no arguments. |
| `SET_SPACING_INSTRUCTION_WITH_UNMAPPED_ARGUMENTS` | The method instruction `spacing` was called with more than one argument. |
| `SET_SPACING_INSTRUCTION_WITH_INVALID_SPACING_VALUE_TYPE` | The method instruction `spacing` was called with an invalid value type for the new spacing value. It must be a number. |
| `SET_SPACING_INSTRUCTION_WITH_INVALID_SPACING_VALUE` | The method instruction `spacing` was called with an invalid number value for the new spacing value. It must be an integer greater than 0. |
